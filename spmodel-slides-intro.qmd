...
* Fit spatial linear and generalized linear models for point-referenced data; geostatistical models
* Fit spatial linear and generalized linear models for areal (lattice) data; autoregressive models
